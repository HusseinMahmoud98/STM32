...
/* Rotate right an 16-bit register with a certain num of bits */
#define ROR_16BIT(REG,NUM) REG=(REG<<NUM)|(REG>>(16-NUM))

/* Rotate left an 16-bit register with a certain num of bits */
#define ROL_16BIT(REG,NUM) REG=(REG>>NUM)|(REG<<(16-NUM))
